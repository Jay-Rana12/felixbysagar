...
const TermsOfService = () => {
    ...
    const terms = [
        ...
        },
        {
            ...
            content: "While our success rate is 100%, visa outcomes are never guaranteed. Felix by Sagar shall not be liable for losses resulting from embassy rejections, policy shifts, or international travel restrictions."
        },
        {
            icon: <Gavel />,
