...
const countries = [
    ...
    {
        id: 'fr', name: 'France', x: '48%', y: '34%', labelPos: 'bottom',
        description: 'The epicenter of European culture and innovation. Specialized support for the French Tech Visa and Talent Passport programs for global talent integration.',
        image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=2673&auto=format&fit=crop',
        success: '100%', sessions: '4,200+',
        tags: ['Tech Visa', 'Talent Passport', 'Schengen'],
        stats: 'Schengen Access',
        visaTypes: ['Talent Passport', 'Student Visa', 'Work Permit', 'Visitor'],
        processingTime: '4-8 Wk',
        keyBenefits: ['Rich Culture', 'EU Access', 'Work-Life Balance'],
        language: 'French',
        climate: 'Temperate'
    },
    {
        id: 'it', name: 'Italy', x: '51%', y: '42%', labelPos: 'bottom',
        description: 'A blend of historic charm and modern enterprise. Premier processing for the Italy Elective Residence and Digital Nomad visas for seamless relocation.',
        image: 'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?q=80&w=2666&auto=format&fit=crop',
        success: '100%', sessions: '3,800+',
        tags: ['Digital Nomad', 'Investor Visa', 'Schengen'],
        stats: 'Historic Hub',
        visaTypes: ['Elective Residence', 'Work Visa', 'Student Visa', 'Investor'],
        processingTime: '4-10 Wk',
        keyBenefits: ['Incredible Lifestyle', 'Historic Heritage', 'Strategic Location'],
        language: 'Italian',
        climate: 'Mediterranean'
    },
    {
        id: 'es', name: 'Spain', x: '46%', y: '39%', labelPos: 'left',
        description: 'Sunny European lifestyle combined with rapid economic growth. Expert guidance for the Spanish Golden Visa and Non-Lucrative Visa pathways.',
        image: 'https://images.unsplash.com/photo-1543783207-ec64e4d95325?q=80&w=2670&auto=format&fit=crop',
        success: '100%', sessions: '5,500+',
        tags: ['Golden Visa', 'Non-Lucrative', 'Schengen'],
        stats: 'High Quality of Life',
        visaTypes: ['Golden Visa', 'Non-Lucrative', 'Digital Nomad', 'Student'],
        processingTime: '3-8 Wk',
        keyBenefits: ['Sunny Climate', 'Affordable Living', 'EU Access'],
        language: 'Spanish',
        climate: 'Mediterranean'
    },
    {
        id: 'ch', name: 'Switzerland', x: '49%', y: '39%', labelPos: 'top',
        description: 'The peak of European financial stability and high standard of living. Specialized entry for Highly Skilled Workers and Investors seeking premium residency.',
        image: 'https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?q=80&w=2670&auto=format&fit=crop',
        success: '100%', sessions: '2,900+',
        tags: ['High Wealth', 'Skilled Worker', 'Schengen'],
        stats: 'Top Financial Hub',
        visaTypes: ['Work Permit', 'Investor Residency', 'Student Visa'],
        processingTime: '8-12 Wk',
        keyBenefits: ['Economic Stability', 'High Salaries', 'Central Europe'],
