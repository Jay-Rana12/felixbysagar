        ...
        <footer ref={footerRef} className="bg-[#050f1e] text-gray-300 relative overflow-hidden border-t border-white/5">
            <div className="container mx-auto px-4 md:px-6 pt-16 pb-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    {/* Brand Column */}
                    <div>
                        <Link to="/" className="flex items-center group mb-10 transition-all duration-300 w-fit">
                            <img src={logo} alt="Felix Logo" className="h-16 md:h-24 w-auto object-contain drop-shadow-md group-hover:scale-[1.02] transition-transform duration-300" />
                        </Link>
                        <p className="text-sm leading-relaxed mb-8 text-gray-400 font-light">
                            Felix by Sagar is a premier immigration consultancy dedicated to realizing your global dreams. With a 100% success rate, we are your trusted bridge to a new life abroad.
                        </p>
                        ...
                        <ul className="space-y-5 text-sm font-light">
                            <li className="flex items-start group">
                                ...
                                <span className="text-gray-400 group-hover:text-white transition-colors">
                                    516, Hilltown Impressa, Opp. Parikh Hospital, Nr. Sivas Scala, Gangotri Circle Road, Nikol, Ahmedabad
                                </span>
                            </li>
