...
const countriesData = [
    ...
    },
    {
        ...
        description: 'The epicenter of European culture and innovation. Specialized support for the French Tech Visa and Talent Passport programs.',
        ...
        visaTypes: ['Talent Passport', 'Student Visa', 'Work Permit'],
    ...
    },
    {
        ...
        description: 'A blend of historic charm and modern enterprise. Premier processing for the Italy Elective Residence and Digital Nomad visas.',
        ...
        visaTypes: ['Elective Residence', 'Work Visa', 'Student Visa'],
    ...
    },
    {
        ...
        description: 'Sunny European lifestyle combined with rapid economic growth. Expert guidance for the Spanish Golden Visa and Non-Lucrative Visa.',
        ...
        visaTypes: ['Golden Visa', 'Non-Lucrative', 'Digital Nomad'],
        processingTime: '3-8 Wk',
    ...
    {
        id: 'ch', name: 'Switzerland', lat: 46.8, lon: 8.2,
        description: 'The peak of European financial stability and high standard of living. Specialized entry for Highly Skilled Workers and Investors.',
                        ...
                        >
                            ...
                            <div className="lg:w-[45%] relative h-[250px] sm:h-[450px] lg:h-auto overflow-hidden group/image border-b lg:border-b-0 lg:border-r border-white/5 flex-shrink-0">
                                ...
                                <div className="absolute bottom-6 sm:bottom-10 left-6 sm:left-10 md:bottom-12 md:left-12 lg:bottom-16 lg:left-16 right-6 sm:right-10">
                                    ...
                                    <h3 className="text-4xl sm:text-6xl md:text-7xl lg:text-[7rem] xl:text-[8rem] font-heading font-black text-white tracking-tighter leading-none uppercase select-none break-words">{selectedCountry.name}</h3>
